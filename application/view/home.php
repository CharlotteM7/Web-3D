...
<head>
    ...
    <!-- Fonts -->
    <link href="https://fonts.googleapis.com/css2?family=Open+Sans&family=Oswald:wght@400;600;700&display=swap" rel="stylesheet">
    <script src="https://kit.fontawesome.com/6ac3910c4e.js" crossorigin="anonymous"></script>
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ms-auto">
          ...
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="#" id="drinksDropdown" role="button" data-bs-toggle="dropdown">Drinks</a>
...
<header class="hero-section position-relative vh-100 d-flex align-items-center justify-content-center text-center overflow-hidden">
 ...
 <div id="counterSection" class="text-center my-4">
  <p>You've clicked <span id="counter">0</span> times!</p>
  <button onclick="countUp()" class="btn btn-outline-primary">Click Me</button>
</div>

<div class="text-center my-4">
  <button id="themeToggle" onclick="changeLook()" class="btn btn-outline-success">Dark Mode</button>
...
<!-- Coke Section -->
      ...
      <div class="card shadow">
        ...
        <div class="card-body text-center">
          ...
          <div class="controls-row d-flex flex-wrap justify-content-center gap-2 mt-4">
            <div id="button-panel">
              <button id="btn" class="btn btn-primary m-2">Animate</button>
              <button id="toggleWireframe" class="btn btn-secondary m-2">Toggle Wireframe</button>
              <button id="Rotate" class="btn btn-secondary m-2">Rotate</button>
            </div>
    ...
    <div class="container py-5">
      <div class="card shadow">
        ...
        <div class="card-body text-center">
          ...
          <div class="controls-row d-flex flex-wrap justify-content-center gap-2 mt-4">
            <div id="button-panel">
              <button id="btn" class="btn btn-primary m-2">Add Ice</button>
              <button id="toggleWireframe" class="btn btn-secondary m-2">Toggle Wireframe</button>
              <button id="Rotate" class="btn btn-secondary m-2">Rotate</button>
            </div>
            <div id="gui-container" class="ms-4"></div>
    ...
    <div class="container py-5">
      <div class="card shadow">
        ...
        <div class="card-body text-center">
          ...
          <div class="controls-row d-flex flex-wrap justify-content-center gap-2 mt-4">
            <div id="button-panel">
              <button id="btn" class="btn btn-primary m-2">Chill</button>
              <button id="toggleWireframe" class="btn btn-secondary m-2">Toggle Wireframe</button>
              <button id="Rotate" class="btn btn-secondary m-2">Rotate</button>
            </div>
            <div id="gui-container" class="ms-4"></div>
  ...
  <div class="container mt-4">
    ...
    <p>Included keyboard navigation, contrast-checked colour schemes, labelled buttons, and alt-text where possible.</p>

    <h2>Future Improvements</h2>
    <ul>
      <li>Integrate model metadata from JSON or SQLite</li>
      <li>Use AJAX for dynamic content loading</li>
      <li>Incorporate gallery views and external API image feeds</li>
      <li>Further optimise loading and model management</li>
    </ul>
  </div>
</div>
</section>
